...
test-coverage:
	...
	lcov -c -d cmake-debug-coverage --rc branch_coverage=1 -o test.info -f --include \*/include/math/\* --include \*/include/math/numerics\* --include \*/math/numerics/lin_alg\* --include \*/math/numerics/ode\*;
	lcov -a test.info -a base.info -o cov.info;

...
test-release:
	./build.sh cmake-release-coverage --test -t=Release -o="MATH_EXTENSIONS=ds,numerics";

build-coverage:
	./build.sh cmake-debug-coverage;

coverage:
	./build.sh cmake-debug-coverage -c -o="MATH_EXTENSIONS=numerics,ds -DMATH_IMAGE_PROCESSING=1";

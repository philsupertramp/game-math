...
\DoxyCodeLine{        \mbox{\hyperlink{classMatrix}{Matrix<double>}} R = \{}
\DoxyCodeLine{            \{cos(theta), -\/sin(theta)\},}
\DoxyCodeLine{            \{sin(theta), cos(theta)\}}
\DoxyCodeLine{        \};}
\DoxyCodeLine{}
...
\DoxyCodeLine{        \textcolor{keywordflow}{for}(\textcolor{keywordtype}{size\_t} i = 0; i < X.rows(); ++i)\{}
\DoxyCodeLine{            row\_mean(0, i) = \mbox{\hyperlink{Matrix_8h_a438e42415f91a5cb3ff198e78e613e33}{mean}}(X.GetSlice(i, i, 0, X.columns() -\/ 1));}
\DoxyCodeLine{        \}}
...
\DoxyCodeLine{        plot.\mbox{\hyperlink{classPlot_ad08d9746d9372ce9c14c042e12cb0a45}{AddData}}(}
\DoxyCodeLine{            pc1,}
\DoxyCodeLine{            \textcolor{stringliteral}{"{}pc 1"{}},}
\DoxyCodeLine{            \mbox{\hyperlink{Plot_8h_afb6eb4f28419b652027fad41104a6d22ab023460c84f774a219d46ccf4665994c}{LINE}}}
\DoxyCodeLine{        );}
\DoxyCodeLine{        \mbox{\hyperlink{classMatrix}{Matrix<double>}} pc2 = \{}
\DoxyCodeLine{            \{mean1, mean2\},}
\DoxyCodeLine{            \{mean1 + U(0, 1) * S(0, 1), mean2 + U(1, 1) * S(0, 1)\}}
\DoxyCodeLine{        \};}
\DoxyCodeLine{        std::cout << \textcolor{stringliteral}{"{}PC2:\(\backslash\)n"{}} << pc2 << std::endl;}
\DoxyCodeLine{        plot.\mbox{\hyperlink{classPlot_ad08d9746d9372ce9c14c042e12cb0a45}{AddData}}(}
\DoxyCodeLine{            pc2,}
\DoxyCodeLine{            \textcolor{stringliteral}{"{}pc 2"{}},}
\DoxyCodeLine{            \mbox{\hyperlink{Plot_8h_afb6eb4f28419b652027fad41104a6d22ab023460c84f774a219d46ccf4665994c}{LINE}}}
\DoxyCodeLine{        );}
\DoxyCodeLine{        plot();}
\DoxyCodeLine{}

...
\DoxyCodeLine{\textcolor{preprocessor}{\#include <math/ds/LogRegSGD.h>}}
\DoxyCodeLine{}
\DoxyCodeLine{}
...
\DoxyCodeLine{        \mbox{\hyperlink{classMatrix}{Matrix<double>}} B                      = where(condition, A, \{ \{ 1 \} \}, \{ \{ -\/1 \} \});}
\DoxyCodeLine{        \textcolor{keyword}{auto} maxVal                           = max(A);}
\DoxyCodeLine{        \textcolor{keyword}{auto} minVal                           = min(A);}

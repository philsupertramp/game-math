...
\DoxyCodeLine{7 }
\DoxyCodeLine{11 \textcolor{keyword}{class }\mbox{\hyperlink{classLogRegSGD}{LogRegSGD}} : \textcolor{keyword}{public} \mbox{\hyperlink{classClassifier}{Classifier}}}
\DoxyCodeLine{12 \{}
...
\DoxyCodeLine{47 }
\DoxyCodeLine{48         \textcolor{keyword}{auto} gradient = (xi.\mbox{\hyperlink{classMatrix_a054a03bcae4eb86d6f4ef84dc87840ef}{Transpose}}() * error) * \mbox{\hyperlink{classClassifier_ada5781f6955d4584bb9e8a24216ce654}{eta}};}
...
\DoxyCodeLine{79         : \mbox{\hyperlink{classClassifier}{Classifier}}(\_eta, iter)}
...
\DoxyCodeLine{94             \mbox{\hyperlink{classClassifier_ada5781f6955d4584bb9e8a24216ce654}{eta}},}
\DoxyCodeLine{95             \mbox{\hyperlink{classClassifier_a262d07b1324365425b12bb08a859984a}{n\_iter}},}
...
\DoxyCodeLine{137         \textcolor{keywordflow}{return} \mbox{\hyperlink{Matrix_8h_afb3f7de2743f10b710460feb9c0f9009}{where}}(condition, \mbox{\hyperlink{classLogRegSGD_ace312230b45f4c6eb9bf42c1f1fc2e87}{activation}}(X), \{ \{ 1 \} \}, \{ \{ -\/1 \} \});}
\DoxyCodeLine{138         \textcolor{comment}{//        return activation(X);}}
\DoxyCodeLine{139     \}}
\DoxyCodeLine{140 }
\DoxyCodeLine{146     \textcolor{keyword}{virtual} \textcolor{keywordtype}{double} \mbox{\hyperlink{classLogRegSGD_aa66da6584236e3253e19d8738248f182}{costFunction}}([[maybe\_unused]] \textcolor{keyword}{const} \mbox{\hyperlink{classMatrix}{Matrix<double>}}\& mat) \{ \textcolor{keywordflow}{return} 0; \}}
\DoxyCodeLine{147 \};}
\DoxyCodeLine{148 }
\DoxyCodeLine{149 }

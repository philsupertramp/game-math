...
public:
    ...
    mat4()
    {
        ...
        values[0][3] = static_cast<T>(0);
        values[1][0] = static_cast<T>(0);
        values[1][1] = static_cast<T>(0);
        values[1][2] = static_cast<T>(0);
        values[1][3] = static_cast<T>(0);
        values[2][0] = static_cast<T>(0);
        values[2][1] = static_cast<T>(0);
        values[2][2] = static_cast<T>(0);
        values[2][3] = static_cast<T>(0);
        values[3][0] = static_cast<T>(0);
        values[3][1] = static_cast<T>(0);
        values[3][2] = static_cast<T>(0);
        values[3][3] = static_cast<T>(0);
    }
    ...
    {
        return vec4<T>(lhs[0][0] * rhs.x + lhs[0][1] * rhs.y + lhs[0][2] * rhs.z + lhs[0][3] * rhs.w,
    ...
    mat4<T>& operator*=(const mat4<T>& rhs)
    {
        T _a = values[0][0], _b = values[0][1], _c = values[0][2], _d = values[0][3], _e = values[1][0],
          _f = values[1][1], _g = values[1][2], _h = values[1][3], _i = values[2][0], _j = values[2][1],
          _k = values[2][2], _l = values[2][3], _m = values[3][0], _n = values[3][1], _o = values[3][2],
          _p         = values[3][3];

...
public:
    ...
    mat3()
    {
        ...
        values[2][0] = static_cast<T>(0); values[2][1] = static_cast<T>(0); values[2][2] = static_cast<T>(0);
    }
    /**
    ...
    mat3(T _a, T _b, T _c, T _d, T _e, T _f, T _g, T _h, T _i)
    {
        ...
        values[2][0] =  _g;  values[2][1] = _h;   values[2][2] =_i;
    }
    /**
    ...
    mat3(vec3<T> A, vec3<T> B, vec3<T> C)
    {
        ...
        values[2][0] = C.x;  values[2][1] =  C.y;  values[2][2] = C.z;
    }
    ~mat3(){
    }
    ...
    inline mat3<T> Transpose(){ return mat3<T>(values[0][0],values[1][0],values[2][0],
    ...
    mat3<T>& operator+=(const mat3<T>& rhs){
        ...
        values[2][0]+=rhs[2][0]; values[2][1]+=rhs[2][1]; values[2][2]+=rhs[2][2];
        return *this;
    }
    mat3<T>& operator-=(const mat3<T>& rhs){
        values[0][0]-=rhs[0][0]; values[0][1]-=rhs[0][1]; values[0][2]-=rhs[0][2];
    ...
    mat3<T>& operator*=(const T& rhs){
        ...
        values[2][0]*=rhs; values[2][1]*=rhs; values[2][2]*=rhs;
        return *this;
    }
    mat3<T>& operator/=(const T& rhs){
        values[0][0]/=rhs; values[0][1]/=rhs; values[0][2]/=rhs;
